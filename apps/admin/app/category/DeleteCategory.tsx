    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg">
        <div className="flex flex-col bg-white justify-between items-center">
          ...
          <p className="font-bold text-2xl pb-3 text-black">Xoá thể loại thời trang</p>
          <p className="text-gray-800 text-center">
            Bạn có chắc chắn muốn xóa thể loại <strong>{category.name}</strong>?
          </p>
          <p className="text-gray-800 text-center">Hành động này sẽ không thể hoàn tác.</p>
        </div>
        <div className="flex flex-row gap-7 justify-center">
          ...
          <Button 
            className="bg-[#FF0000] text-white text-xl hover:bg-[#db0606] w-32 mt-3 rounded-3xl disabled:opacity-50"
