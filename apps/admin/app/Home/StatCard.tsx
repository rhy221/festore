    ...
    <Card className={`${bgColor} border-0 w-61 h-33 rounded-[45px] pt-3`}>
      <CardContent className="">
        ...
        <div className="flex items-center justify-center gap-7">
          {/* Icon */}
          <div className="text-white/90">{img}</div>

          {/* Number */}
          <div className="text-white text-5xl font-extrabold">{value}</div>
        </div>
      </CardContent>
    </Card>
  );
...
export default function QuickStats({
  ...
  const stats = [
    {
      ...
      value: userCount,
      img: (
        <Image src="/totalUser.png" alt="Total User" width={50} height={50} />
      ),
      bgColor: "bg-[#00C853]",
    },
    {
  ...
  return (
    <div className="pl-7 pt-5">
      <h1 className="text-[32px] font-extrabold mb-3">Thống kê nhanh</h1>
