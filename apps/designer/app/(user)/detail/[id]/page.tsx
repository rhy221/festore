...
}) 
{
  ...
  return (
    <div className=" bg-black/95 flex items-center justify-center p-4 overflow-auto">
          <GalleryItemModal id={id} />
...
//   return (
// <div className=" fixed inset-0 flex flex-col items-center justify-start z-50 pointer-events-auto overflow-auto ">
//       <button
//         onClick={() => window.history.back()}
//         className="absolute top-6 right-6 text-white/70 hover:text-white transition-colors z-10"
//       >
