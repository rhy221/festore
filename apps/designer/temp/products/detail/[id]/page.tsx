...
//   return (
// <div className="relative w-full min-h-screen bg-black/90 z-50 ">
//       <button
//         // onClick={onClose}
...
//       <div className="w-full max-w-7xl h-full max-h-[90vh] flex">
...
//         </div>
//       </div>
//       <div className='w-full h-[1080px] bg-amber-300'></div>
//     </div>
//   );
// }
